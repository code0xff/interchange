...
export const protobufPackage = 'code0xff.interchange.ibcdex'
...
export class QueryClientImpl implements Query {
  ...
  DenomTrace(request: QueryGetDenomTraceRequest): Promise<QueryGetDenomTraceResponse> {
    ...
    const promise = this.rpc.request('code0xff.interchange.ibcdex.Query', 'DenomTrace', data)
  ...
  DenomTraceAll(request: QueryAllDenomTraceRequest): Promise<QueryAllDenomTraceResponse> {
    ...
    const promise = this.rpc.request('code0xff.interchange.ibcdex.Query', 'DenomTraceAll', data)
  ...
  BuyOrderBook(request: QueryGetBuyOrderBookRequest): Promise<QueryGetBuyOrderBookResponse> {
    ...
    const promise = this.rpc.request('code0xff.interchange.ibcdex.Query', 'BuyOrderBook', data)
  ...
  BuyOrderBookAll(request: QueryAllBuyOrderBookRequest): Promise<QueryAllBuyOrderBookResponse> {
    ...
    const promise = this.rpc.request('code0xff.interchange.ibcdex.Query', 'BuyOrderBookAll', data)
  ...
  SellOrderBook(request: QueryGetSellOrderBookRequest): Promise<QueryGetSellOrderBookResponse> {
    ...
    const promise = this.rpc.request('code0xff.interchange.ibcdex.Query', 'SellOrderBook', data)
  ...
  SellOrderBookAll(request: QueryAllSellOrderBookRequest): Promise<QueryAllSellOrderBookResponse> {
    ...
    const promise = this.rpc.request('code0xff.interchange.ibcdex.Query', 'SellOrderBookAll', data)
