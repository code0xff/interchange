...
export class MsgClientImpl {
    ...
    CancelBuyOrder(request) {
        ...
        const promise = this.rpc.request('code0xff.interchange.ibcdex.Msg', 'CancelBuyOrder', data);
    ...
    CancelSellOrder(request) {
        ...
        const promise = this.rpc.request('code0xff.interchange.ibcdex.Msg', 'CancelSellOrder', data);
    ...
    SendBuyOrder(request) {
        ...
        const promise = this.rpc.request('code0xff.interchange.ibcdex.Msg', 'SendBuyOrder', data);
    ...
    SendSellOrder(request) {
        ...
        const promise = this.rpc.request('code0xff.interchange.ibcdex.Msg', 'SendSellOrder', data);
    ...
    SendCreatePair(request) {
        ...
        const promise = this.rpc.request('code0xff.interchange.ibcdex.Msg', 'SendCreatePair', data);
