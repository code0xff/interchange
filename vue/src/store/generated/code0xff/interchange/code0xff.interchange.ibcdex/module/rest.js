...
export class Api extends HttpClient {
    constructor() {
         ...
         * @request GET:/code0xff/interchange/ibcdex/buyOrderBook
         */
        this.queryBuyOrderBookAll = (query, params = {}) => this.request({
            path: `/code0xff/interchange/ibcdex/buyOrderBook`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/code0xff/interchange/ibcdex/buyOrderBook/{index}
         */
        this.queryBuyOrderBook = (index, params = {}) => this.request({
            path: `/code0xff/interchange/ibcdex/buyOrderBook/${index}`,
            method: "GET",
            format: "json",
            ...params,
        });
         ...
         * @request GET:/code0xff/interchange/ibcdex/denomTrace
         */
        this.queryDenomTraceAll = (query, params = {}) => this.request({
            path: `/code0xff/interchange/ibcdex/denomTrace`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/code0xff/interchange/ibcdex/denomTrace/{index}
         */
        this.queryDenomTrace = (index, params = {}) => this.request({
            path: `/code0xff/interchange/ibcdex/denomTrace/${index}`,
            method: "GET",
            format: "json",
            ...params,
        });
         ...
         * @request GET:/code0xff/interchange/ibcdex/sellOrderBook
         */
        this.querySellOrderBookAll = (query, params = {}) => this.request({
            path: `/code0xff/interchange/ibcdex/sellOrderBook`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/code0xff/interchange/ibcdex/sellOrderBook/{index}
         */
        this.querySellOrderBook = (index, params = {}) => this.request({
            path: `/code0xff/interchange/ibcdex/sellOrderBook/${index}`,
            method: "GET",
            format: "json",
            ...params,
        });
