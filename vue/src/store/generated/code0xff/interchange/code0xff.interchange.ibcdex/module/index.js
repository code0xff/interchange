...
const txClient = async (wallet, { addr: addr } = { addr: "http://localhost:26657" }) => {
    ...
    return {
        ...
        msgSendSellOrder: (data) => ({ typeUrl: "/code0xff.interchange.ibcdex.MsgSendSellOrder", value: data }),
        msgCancelSellOrder: (data) => ({ typeUrl: "/code0xff.interchange.ibcdex.MsgCancelSellOrder", value: data }),
        msgSendCreatePair: (data) => ({ typeUrl: "/code0xff.interchange.ibcdex.MsgSendCreatePair", value: data }),
        msgSendBuyOrder: (data) => ({ typeUrl: "/code0xff.interchange.ibcdex.MsgSendBuyOrder", value: data }),
        msgCancelBuyOrder: (data) => ({ typeUrl: "/code0xff.interchange.ibcdex.MsgCancelBuyOrder", value: data }),
    };
};
